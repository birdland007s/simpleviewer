...
let panelDisabled = window.panelDisabled;
const initializeMarker = window.initializeMarker;
const rac = window.rac;
const initializeControlPanel = window.initializeControlPanel;
const initDraggableDiv = window.initDraggableDiv;
