...
export default React.Component({
  ...
  onTogglePublished(event) {
    this.props.actions.publishView({
      viewBucket: this.props.viewBucket,
  ...
  onAddCollaborator(event) {
    ...
    const tags = (view.data && view.data.tags) || [];
    ...
    if (collaborator !== '' && tags.indexOf(collaborator) === -1) {
      this.props.actions.updateViewTags({
        viewBucket: this.props.viewBucket,
  ...
  onRemoveCollaborator(collaborator) {
    ...
    let tags = (view.data && view.data.tags) || [];
        ...
        return (
          <div className="dialog-column share-collaborate">
            <div className="settings-group">
              <p>
                Add an email address of another Simpleview user to share a view.
                You&apos;ll both be able to edit and view the view. You can also
        ...
        return (
          <div className="dialog-column share-publish">
            <div className="settings-group">
              ...
              <p>
                Ready to share your view with the world? Anyone with the public
                ...
                <div className="settings-items theme-color-border">
                  <div className="settings-item theme-color-border">
                    <input
                      ...
                      className="settings-item-text-input transparent-input"
                      placeholder={
                        isPublished ? 'Publishing view…' : 'View not published'
                      }
                      value={publishURL}
                    />
                    <div className="settings-item-control">
